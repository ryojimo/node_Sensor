 ...
 * updateData30s( 28.4 );
*/
DataSensor.prototype.updateData30s = function( data ){
...
*/
DataSensor.prototype.updateData1day = function( data ){
  console.log( "[DataSensor.js] updateData30s()" );
 ...
 * isLarge();
*/
DataSensor.prototype.isLarge = function(){
//  console.log( "[DataSensor.js] isLarge()" );

  var diff = this.data30s['10秒前'] - this.data30s['今'];
  var ret = false;
